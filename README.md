...
MYSQL_PORT = 10132
MYSQL_USER = "avnadmin"
MYSQL_PASSWORD = "<votre_mot_de_passe_aiven>"
...
Les écritures MySQL sont gérées directement par le listener Python (`mqtt_listener.py`).
Les tables sont créées automatiquement au démarrage de l'application Streamlit.

Les nœuds MySQL dans Node-RED ont été supprimés pour éviter les problèmes de compatibilité SSL.
